...
class AddonPreferences(bpy.types.AddonPreferences):
	...
	display_tris           : BoolProperty( name="Tris", description="Display triangles", default=False, )
...
def register():
	...
	bpy.types.VIEW3D_PT_view3d_properties.prepend(displayMeshCheckPanel)
...
def unregister():
	...
	bpy.types.VIEW3D_PT_view3d_properties.remove(displayMeshCheckPanel)
